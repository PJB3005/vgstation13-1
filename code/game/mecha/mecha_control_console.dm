...
/obj/machinery/computer/mecha/Topic(href, href_list)
	...
	if(href_list["send_message"])
		var/obj/item/mecha_parts/mecha_tracking/MT = _filter.getObj("send_message")
	...
	if(href_list["lockdown"])
		var/obj/item/mecha_parts/mecha_tracking/MT = _filter.getObj("lockdown")
		var/obj/mecha/M = MT.in_mecha()
		if(M.state)
			usr << "That exosuit is already under lockdown!"
			return
	...
	if(href_list["shock"])
		switch(alert("Are you sure? This cannot be undone.","Transmit Beacon Self-Destruct Code","Yes","No"))
			if ("Yes")
				var/obj/item/mecha_parts/mecha_tracking/MT = _filter.getObj("shock")
				MT.shock()
			if ("No")
				usr << "You have second thoughts."
	if(href_list["get_log"])
		var/obj/item/mecha_parts/mecha_tracking/MT = _filter.getObj("get_log")
